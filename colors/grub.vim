...
let s:rare_gray       = { "gui": "#504945", "cterm": "243" } "gray"
...
let s:light_black     = { "gui": "#0D0D0D", "cterm": "235" } "dark gray"
...
if &background == "dark"
  ...
  let s:norm_subtle     = s:rare_gray     "braces, lots of keywords and delineators"
