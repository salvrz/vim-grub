...
let s:dark_gray       = { "gui": "#0D0D0D", "cterm": "243" } "gray"
...
let s:light_black     = { "gui": "#2F2F2F", "cterm": "235" } "dark gray"
...
if &background == "dark"
  ...
  let s:norm_subtle     = s:dark_gray     "braces, lots of keywords and delineators"
